...
public class ProductInterface extends JFrame {
    ...
    public ProductInterface(GUI mainInterface) {
        ...
        btnNewButton = new JButton("Insert Product");

        btnNewButton.setBounds(10, 467, 189, 48);
        getContentPane().add(btnNewButton);

        btnNewButton_1 = new JButton("Delete Product");

        btnNewButton_1.setBounds(10, 526, 189, 53);
        getContentPane().add(btnNewButton_1);

        btnNewButton_2 = new JButton("Update Product");
